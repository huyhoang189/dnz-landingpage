...
<div class="thong-tin-meta">
	<span class="ngay-dang-bai"><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo get_the_date();?></span><span class="luot-xem">
<i class="fa fa-eye" aria-hidden="true"></i> <?php echo getPostViews(get_the_ID()); ?> </span>
</div>					<?php if($show_excerpt !== 'false') { ?>
